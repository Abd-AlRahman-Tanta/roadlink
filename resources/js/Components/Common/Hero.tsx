...
const Hero = ({ hero }: { hero: HeroProps }) => {
  return (
    <div className=' relative w-full min-h-screen flex flex-col justify-center items-center gap-24 saveSpace pt-20 overflow-hidden'>
      {/* background */}
      <img className=' w-full h-full absolute top-20 left-0 object-cover -z-10' src={hero.image} alt="" />
      {/* layer */}
