...
const Service = ({ image, description, explainations, layerDestination }: { layerDestination?: string, image: string, description: string, explainations: string[] }) => {
  return (
    <div className="group  flex flex-col justify-end items-start p-6 relative aspect-[0.8/1] w-full rounded-lg overflow-hidden  ">
      ...
      <RegularLayer className={`${layerDestination ? layerDestination : "from-5% to-50%"}`} />
